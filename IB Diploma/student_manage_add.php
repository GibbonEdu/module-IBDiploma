...
if (isActionAccessible($guid, $connection2, '/modules/IB Diploma/student_manage_add.php') == false) {
    ...
    $row = $form->addRow();
        ...
        $row->addSelectStudent('gibbonPersonID',$session->get('gibbonSchoolYearID'), array('allStudents' => true, 'byName' => false, 'byForm' => true, 'showForm' => true))->selectMultiple()->isRequired();
